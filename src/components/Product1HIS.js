...
export default function Product1HIS() {
    return (
        <>
            <div className='Product'>
                {Products.map((product) => (
                    <div key={product.id} className='EachProduct'>
                        <img src={product.ProdImg} alt="Product" className="ProductImg" style={product.id === 2 ? {
                            position: "relative", bottom: "0px", top: "100px", width: "449px",
                            height: "360px"
                        } : {}}></img>
